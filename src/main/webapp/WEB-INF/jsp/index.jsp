...
<!-- end footer -->
<!-- Javascript files-->
<script src="${basePath}/vendor/js/jquery.min.js"></script>
<script src="${basePath}/vendor/js/popper.min.js"></script>
<script src="${basePath}/vendor/js/bootstrap.bundle.min.js"></script>
<script src="${basePath}/vendor/js/jquery-3.0.0.min.js"></script>
<script src="${basePath}/vendor/js/plugin.js"></script>
<!-- Scrollbar Js Files -->
<script src="${basePath}/vendor/js/jquery.mCustomScrollbar.concat.min.js"></script>
<script src="${basePath}/vendor/js/custom.js"></script>
</body>
</body>
